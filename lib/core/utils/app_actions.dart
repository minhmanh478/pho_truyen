  ...
  static Future<void> openContact(BuildContext context) async {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Row(
          children: [
            Icon(Icons.support_agent_rounded, color: AppColor.blackPrimary),
            SizedBox(width: 8),
            Text(
              'Liên hệ hỗ trợ',
        ...
        content: const Text(
          ...
          style: TextStyle(fontSize: 15, color: AppColor.primaryLight),
        ),
        actionsAlignment: MainAxisAlignment.spaceBetween,
        actions: [
          TextButton(
            onPressed: () {
              Clipboard.setData(const ClipboardData(text: 'm@123.com'));
            ...
            child: const Text(
              'Sao chép',
              style: TextStyle(color: AppColor.backgroundDark),
            ),
          ),
          TextButton(
            onPressed: () async {
            ...
            child: const Text(
              'Gửi mail',
              style: TextStyle(color: AppColor.blackPrimary),
            ),
          ),
        ],
      ),
